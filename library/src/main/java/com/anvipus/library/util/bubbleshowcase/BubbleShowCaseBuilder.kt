...
class BubbleShowCaseBuilder{
    ...
    internal var mShowcaseSize: Int? = null
    internal var mShowcasePosition: Int? = null
    ...
    internal var mHasNavBar: Boolean? = null
    internal var mNavBarHeight: Int? = null
    ...
    constructor(activity: Activity, hasNavBar: Boolean, navBarHeight: Int) {
        mActivity = WeakReference(activity)
    ...
    fun showcaseSize(size: Int): BubbleShowCaseBuilder {
        mShowcaseSize = size
        return this
    }

    fun showcasePosition(position: Int): BubbleShowCaseBuilder {
        mShowcasePosition = position
        return this
    }

...
class Constants {
    companion object {
        ...
        const val ERROR_TAG = "error_log"

        const val KEY_IS_FIRST_OPEN_APP = "is_first_open_app"
        const val KEY_IS_ONBOARDING_HIDE = "is_onboarding_hide"
        const val KEY_HAS_TUTORIAL_SHOWN = "hasTutorialShown"
        const val KEY_CAMPAIGN_CODE = "CAMPAIGN_CODE"
